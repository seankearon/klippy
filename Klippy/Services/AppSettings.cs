...
public sealed class AppSettings
{
    ...
    /// <summary>
    /// The local variables file: <c>%name%</c> defines a snippet expands on copy. A bare
    /// name sits beside the snippets, an absolute path is taken as given — which is how a
    /// snippet store shared between two machines still reads a file local to each.
    /// </summary>
