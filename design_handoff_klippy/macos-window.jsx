...
function MacWindow({
  ...
  sidebar, plain = false, background = '#fff', titlebarColor = 'rgba(0,0,0,0.85)', children,
}) {
  ...
  return (
    ...
    <div data-om-starter="macos-window" style={{
      width: w, height: h, borderRadius: 26, overflow: 'hidden',
      background,
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', minWidth: 0 }}>
          <div style={{
            ...
            <div style={{
              ...
              fontFamily: MAC_FONT, fontSize: 13, fontWeight: 600, color: titlebarColor,
              pointerEvents: 'none',
            }}>{title}</div>
          </div>
